...
const Page = () => {
  ...
  const cowDetails = [
    { label: "एकूण लिटर", value: totalLiterCow }, // Replace with `totalLiterCow`
    { label: "Avg फॅट", value: avgFatCow }, // Replace with `avgFatCow`
    { label: "Avg SNF", value: avgSnfCow }, // Replace with `avgSnfCow`
    { label: "Avg दर", value: avgRateCow }, // Replace with `avgRateCow`
    { label: "Total रक्कम ", value: totalRakkamCow }, // Replace with `totalRakkamCow`
  ];

  const buffaloDetails = [
    { label: "एकूण लिटर", value: totalLiter }, // Replace with `totalLiter`
    { label: "Avg फॅट", value: avgFat }, // Replace with `avgFat`
    { label: "Avg SNF", value: avgSnf }, // Replace with `avgSnf`
    { label: "Avg दर", value: avgRate }, // Replace with `avgRate`
    { label: "एकूण रक्कम ", value: totalRakkam }, // Replace with `totalRakkam`
  ];
      ...
      <div className=" sm:bg-gray-500 border border-gray-300 w-4/4 sm:w-7/12 mx-auto h-auto py-4 px-3 rounded-lg">
        <div className="flex flex-row bg-slate-300 mb-4 rounded-lg">
          ...
          <h1 className="text-xl text-white font-semibold relative z-10">
            <span className="z-1 text-blue-500">{ownerName || "Guest"}</span>
        ...
        <button
          onClick={toggleModal}
          type="button"
          className="bg-green-400 border rounded-md p-1 text-gray-700 text-sm w-1/2 mt-4 mb-2"
        >
          न आलेले उत्पादक
        </button>
