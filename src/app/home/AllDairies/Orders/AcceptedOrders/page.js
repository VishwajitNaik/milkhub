        ...
        <div className="min-h-screen p-6 bg-gray-100 gradient-bg">
            ...
            <div className="flex overflow-x-auto space-x-4 mb-6 pb-2">
                {Object.values(groupedOrders).map((dairy) => {
                    const acceptedCount = dairy.orders.filter(o => o.status === "Accepted").length;
                    return (
                        <button
                            key={dairy.dairyName}
...
const OrderCard = ({ order }) => (
    <div className="min-w-[280px] p-5 bg-gradient-to-br from-blue-200 to-blue-300 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-105">
